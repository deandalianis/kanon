    ...
    return (
        <Panel>
            <SectionHeader
                eyebrow="BDD"
                title="Scenarios"
                description="Derived scenarios grouped from the semantic spec's cited scenario section."
                badge={
            ...
            {aggregates.length === 0 ? (
                <EmptyState
                    ...
                    detail="Derived scenarios appear here when the semantic spec contains a top-level scenarios section."
                />
            ) : (
