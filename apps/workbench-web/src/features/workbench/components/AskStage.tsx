      ...
      <div className="stage-main">
        <Panel>
          <SectionHeader
            eyebrow="Ask"
            title="Ask the spec"
            description="Ask questions about this service's domain model. Answers are grounded in the approved spec and canonical IR only."
          />

          {!hasSpec ? (
            <EmptyState
              title="No approved spec"
              detail="An approved spec is required before asking questions. Build and approve a spec first."
            />
          ) : (
