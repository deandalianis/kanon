...
public final class ObservabilityPlugin implements CompilerPlugin {
    ...
    public void apply(GenerationContext context) {
        ...
        String source = PluginSupport.provenanceHeader(context)
                ...
                + "    public static final String COMMAND_DURATION = \"specctl.command.duration\";" +
                ...
                + "}" + System.lineSeparator();
        context.writeFile("src/generated/java/obs", packageBase.replace('.', '/') + "/GeneratedObservability.java",
                source);
    }
}
