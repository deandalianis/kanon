...
public final class SpecCompiler {
    ...
    private List<GeneratedFile> generate(SpecDocument spec, Path targetRoot, List<RegisteredPlugin> plugins,
    ...
    public record CompilationArtifact(SpecDocument source, CanonicalIr canonicalIr,
