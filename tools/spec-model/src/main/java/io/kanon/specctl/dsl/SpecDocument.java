...
public record SpecDocument(
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record Command(String name, Http http, Input input, List<Rule> rules,
                          @JsonInclude(JsonInclude.Include.NON_EMPTY) List<String> emits, List<BddScenario> scenarios) {
        public Command {
