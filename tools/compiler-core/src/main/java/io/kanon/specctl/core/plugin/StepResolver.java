...
public final class StepResolver {
    ...
    private String resolveAssert(CanonicalIr.ImplStep impl, String indent) {
        ...
        return indent + "org.springframework.util.Assert.state(" + expr + ", \"" + escapeString(msg) + "\");" + System.lineSeparator();
    }
    ...
    private String resolveNullCheck(CanonicalIr.ImplStep impl, String indent) {
        ...
        return indent + "org.springframework.util.Assert.notNull(" + expr + ", \"" + escapeString(msg) + "\");" + System.lineSeparator();
    }
    ...
    private String resolveCollectionCheck(CanonicalIr.ImplStep impl, String indent) {
        ...
        return indent + "org.springframework.util.Assert.state(!" + expr + ".isEmpty(), \"" + escapeString(msg) + "\");" + System.lineSeparator();
    }
    ...
    public String stubMethod(String stepText, String commandName, int stepIndex, String requestType, String runtimePackage) {
        String methodName = "step_" + toSafeIdentifier(commandName) + "_" + stepIndex;
        ...
        return "    @" + annotationFqn + "(\"" + escapeString(stepText) + "\")" + System.lineSeparator()
                ...
                + "        throw new UnsupportedOperationException(\"Step not implemented: " + escapeString(stepText) + "\");" + System.lineSeparator()
